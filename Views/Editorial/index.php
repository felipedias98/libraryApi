...
<div class="app-title">
    <div>
        <h1><i class="fa fa-dashboard"></i> Editoras</h1>
    </div>
</div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header bg-primary text-white">
                <h5 class="modal-title text-white" id="title">Cadastrar editora</h5>
            ...
            <div class="modal-body">
                <form id="frmEditorial">
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <button class="btn btn-primary" type="submit" onclick="registrarEditorial(event)" id="btnAccion">Cadastrar</button>
