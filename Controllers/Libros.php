...
class Libros extends Controller
{
    ...
    public function eliminar($id)
    {
        ...
        if ($data == 1) {
            $msg = array('msg' => 'Livro dado baixa!', 'icono' => 'success');
        } else {
            $msg = array('msg' => 'Erro ao dar baixa!', 'icono' => 'error');
        }
        echo json_encode($msg, JSON_UNESCAPED_UNICODE);
        die();
    }
    public function reingresar($id)
    {
        ...
        if ($data == 1) {
            $msg = array('msg' => 'Livro reingressado!', 'icono' => 'success');
        } else {
            $msg = array('msg' => 'Erro ao reingressar o livro!', 'icono' => 'error');
        }
        echo json_encode($msg, JSON_UNESCAPED_UNICODE);
        die();
    }
    public function verificar($id_libro)
    {
        if (is_numeric($id_libro)) {
            ...
            $msg = array('msg' => 'Erro Fatal', 'icono' => 'error');
        }
        echo json_encode($msg, JSON_UNESCAPED_UNICODE);
        die();
    }
